...
export function installMockBackend() {
  ...
  mockIPC((command, payload) => {
    ...
    /* The branch list, in the order `git::by_recency` would have given it: the
       ...
       because it is the loudest case of it — it creates a branch and moves HEAD
       — and because the refusal is worth seeing: pressing it in `npm run dev`
       draws the panel's own refusal block over the branch list, which is what
       the app draws for a git that declined. Which leaves the
