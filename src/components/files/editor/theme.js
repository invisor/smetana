/* Тема редактора — единственный файл в src/, которому разрешено порождать
   ...
   EditorView.darkTheme, а на него смотрят базовые темы расширений — панель
   поиска, спецсимволы, парные скобки, — и начали бы подставлять собственные
   захардкоженные цвета через плейсхолдеры &light / &dark. Поэтому тема ниже
   исчерпывающая: всё, что базовые темы красят сами, перекрашено токеном. */
